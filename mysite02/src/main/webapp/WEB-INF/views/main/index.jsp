		...
		<div id="wrapper">
			<div id="content">
				<div id="site-introduction">
					<% if (authUser != null) { %>
					<img id="profile" src="<%=request.getContextPath() %>/assets/images/dooly.jpg" style="width:200px">
					<h2>안녕하세요.<br><%=authUser.getName() %>의 MySite에 오신 것을 환영합니다.</h2>
					<% } %>
					<p>
						이 사이트는  웹 프로그래밍 실습과제 예제 사이트입니다.<br>
						메뉴는  사이트 소개, 방명록, 게시판이 있구요.<br>
						Java 수업 + 데이터베이스 수업 + 웹 프로그래밍 수업 배운 거 있는거 없는 거 다 합쳐서 만들어 놓은 사이트 입니다.<br><br>
